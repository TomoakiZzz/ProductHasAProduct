    ...
    <div class="goods_wrap" v-if="goodsItem">
        ...
        <div class="goods_info">
            <div class="goods_price_new">
                ...
                <span class="share">分享赚{{goodsItem.earnMoney}}</span>
            </div>
            <div class="goods_price_older">
                <span>市场价：18.88</span><span>自提价：18.88</span>
            </div>
        ...
        <div class="goods_standard">
            ...
            <div class="goods_standard_info">
                ...
                <div class="goods_standard_ticket">
                    <span>每满300减35券</span><span>满199减20券</span>
                </div>
                <i></i>
            </div>
            <div class="goods_standard_info">
                <span>说明</span>
                <div class="goods_standard_explain">
                    假一赔十|7天无忧退货|一站式购齐
                </div>
            </div>
            <div class="goods_standard_info">
                <span>提示</span>
                <div class="goods_standard_msg">
                    {{packageInfo}}
                </div>
            </div>
        </div>
